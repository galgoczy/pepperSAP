-- PEPPER HOUSE PÉNZÜGYI RENDSZER - TELJES SÉMA (ÚJRAFUTTATHATÓ)
-- Supabase PostgreSQL

-- ============================================
-- 0. TÖRLÉSEK (biztonságos újrafuttatáshoz)
-- ============================================
...
-- Admin (gergo@pepperhouse.hu)
INSERT INTO user_profiles (id, full_name, role, unit_id)
VALUES ('86545aee-8159-48e7-836e-3ea7c59cfede', 'Gergő Admin', 'admin', NULL)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  role = EXCLUDED.role,
  unit_id = EXCLUDED.unit_id;

-- Unit user (unit@pepperhouse.hu) - Központi Étterem
INSERT INTO user_profiles (id, full_name, role, unit_id)
SELECT
  '46f91f98-6066-4744-b191-2f0dea950034',
...
-- Events user (events@pepperhouse.hu) - Rendezvény Egység
INSERT INTO user_profiles (id, full_name, role, unit_id)
SELECT
  '4b95c6e9-2466-46f4-a08e-1cd7caff0898',
